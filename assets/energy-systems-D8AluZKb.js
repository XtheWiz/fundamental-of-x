import{j as W}from"./main-Ds-YDU3R.js";import{L as R}from"./LegacyWidget-xvrQRn42.js";const j=[{name:"Solar PV (utility)",cf:.22,color:"#f5a623"},{name:"Wind onshore",cf:.35,color:"#2b6cb0"},{name:"Wind offshore",cf:.48,color:"#1a4d80"},{name:"Hydro",cf:.4,color:"#4ec9ff"},{name:"Coal",cf:.55,color:"#4a4a4a"},{name:"Gas (CCGT)",cf:.55,color:"#888"},{name:"Nuclear",cf:.92,color:"#9c27b0"},{name:"Battery (4-hr)",cf:.12,color:"#4caf50"}],G=[{name:"100 W bulb (1 hr)",wh:100},{name:"Phone full charge",wh:15},{name:"EV daily commute",wh:8e3},{name:"Home daily",wh:3e4},{name:"Steel factory daily",wh:5e7},{name:"Small town daily",wh:5e8},{name:"NYC daily",wh:16e10},{name:"USA daily",wh:11e12}];function I(a){let r=1e3;a.innerHTML=`
    <div class="widget">
