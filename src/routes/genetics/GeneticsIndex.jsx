...
export default function GeneticsIndex() {
  useEffect(() => {
    document.title = 'Fundamental of Genetics — Visual Crash Course';
  }, []);
      ...
      <SiteHeader
        breadcrumb={
          <>
            ...
            <span className="current">Genetics</span>
          </>
        }
      />
      <main className="hub">
        <section className="intro">
          ...
          <h1>Fundamental of <span className="x">Genetics</span></h1>
          <p>{manifest.intro}</p>
          <MascotHello />
        </section>
        ...
        <section>
          ...
          <div className="lesson-grid">
            {manifest.lessons.map((l, i) => (
              <Link className="lesson-card" key={l.slug} to={`/topics/genetics/lessons/${l.slug}`}>
