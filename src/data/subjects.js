...
// `ported: true` => link via React route; `false` => fall back to static HTML.
// All 18 topics are now React-native; the fallback only exists for safety.

const C = (title, body, slug, ported = true) => ({
  title,
  body,
  slug,
  ported,
...
export const CATEGORIES = [
  ...
  },
  {
    ...
    subjects: [
      ...
      C('Compilers', 'How does the file you wrote become bytes the CPU runs? Lexer, parser, AST, IR, optimization, codegen — every pass, interactive.', 'compilers'),
