...
import DecoratorAdapterWidget from '../widgets/design-patterns/DecoratorAdapterWidget.jsx';
import ModernArchWidget from '../widgets/design-patterns/ModernArchWidget.jsx';
...
export const manifest = {
  ...
  lessons: [
    ...
    { slug: 'decorator-adapter', number: '05', title: 'Decorator & Adapter', blurb: 'Wrapping existing things.', Widget: DecoratorAdapterWidget,
    ...
    { slug: 'modern-architecture', number: '08', title: 'Modern Architecture Patterns', blurb: 'MVC / MVVM, CQRS, Event Sourcing, Circuit Breaker, Saga, Outbox.', Widget: ModernArchWidget,
